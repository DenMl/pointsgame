...
namespace DotsTests
{
	...
	public class FieldTest
	{
		...
		public void ThreeAdjacentBasesTest()
		{
			...
			field.MakeMove(StartX_ + 3, StartY_ - 1);
			field.MakeMove(StartX_, StartY_ + 1);
			...
			field.MakeMove(StartX_ + 3, StartY_ - 2);

			field.MakeMove(StartX_, StartY_ - 2);
		...
		public void BigEmptyBaseTest()
		{
			...
			field.MakeMove(StartX_ + 4, StartY_);
			field.MakeMove(StartX_ + 10, StartY_ + 4);

			// right chain.
			field.MakeMove(StartX_ + 5, StartY_ + 1);
			...
			field.MakeMove(StartX_ + 10, StartY_ + 7);

			field.MakeMove(StartX_ + 5, StartY_ + 4);
			field.MakeMove(StartX_ + 10, StartY_ + 8);

			// bottom chain.
			field.MakeMove(StartX_ + 4, StartY_ + 5);
			field.MakeMove(StartX_ + 10, StartY_ + 9);

			field.MakeMove(StartX_ + 3, StartY_ + 5);
			field.MakeMove(StartX_ + 10, StartY_ + 10);

			field.MakeMove(StartX_ + 2, StartY_ + 5);
			field.MakeMove(StartX_ + 10, StartY_ + 11);

			field.MakeMove(StartX_ + 1, StartY_ + 5);
			field.MakeMove(StartX_ + 10, StartY_ + 12);

			field.MakeMove(StartX_, StartY_ + 5);
			field.MakeMove(StartX_ + 10, StartY_ + 13);

			field.MakeMove(StartX_ - 1, StartY_ + 5);
			field.MakeMove(StartX_ + 10, StartY_ + 14);

			// left chain.
			field.MakeMove(StartX_ - 2, StartY_ + 4);
			field.MakeMove(StartX_ + 10, StartY_ + 15);

			field.MakeMove(StartX_ - 2, StartY_ + 3);
			field.MakeMove(StartX_ + 10, StartY_ + 16);

			field.MakeMove(StartX_ - 2, StartY_ + 2);
			field.MakeMove(StartX_ + 10, StartY_ + 17);

			field.MakeMove(StartX_ - 1, StartY_ + 1);
			field.MakeMove(StartX_ + 10, StartY_ + 18);

			// center.
			Assert.AreEqual(field.MakeMove(StartX_, StartY_ + 3), true);
			field.MakeMove(StartX_ + 10, StartY_ + 19);

			Assert.AreEqual(field.MakeMove(StartX_ + 2, StartY_ + 2), true);
			field.MakeMove(StartX_ + 10, StartY_ + 20);

			Assert.AreEqual(field.MakeMove(StartX_ + 2, StartY_ + 3), true);
			field.MakeMove(StartX_ + 10, StartY_ + 21);

			Assert.AreEqual(field.MakeMove(StartX_ + 3, StartY_ + 3), true);
